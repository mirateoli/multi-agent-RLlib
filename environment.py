...
class Environment(MultiAgentEnv):
    ...
    def __init__(self, config: EnvContext):
        ...
        if self.train:
            ...
            self.start_pts = [random.sample(self.free_coords, 1)] * self.num_agents # same start points if doing branching
            self.end_pts = self.end_pts = random.sample(self.free_coords, self.num_agents)
